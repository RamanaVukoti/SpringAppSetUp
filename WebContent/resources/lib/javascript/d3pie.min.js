        ...
        d = {
            ...
            addSVGSpace: function(a) {
                var b = a.element,
                    ...
                    f = d3.select(b).text("").append("svg:svg").attr("width", c).attr("height", d);
            ...
            var a, b, c, d, e, f, h = arguments[0] || {}, i = 1,
                j = arguments.length,
                k = !1,
            ...
            create: function(a) {
                var b = a.pieCenter,
                    ...
                    g = d3.svg.arc().innerRadius(a.innerRadius).outerRadius(function(){
                    	
                    	
                    	var cwidth=(($(window).width()/4));
                    	return cwidth<350?((a.outerRadius)*(2/3)):a.outerRadius
