...
function MenuDirective($mdMenu) {
  ...
  function compile(templateElement) {
    ...
    if (!triggerElement.hasAttribute('ng-mouseover')) {
      triggerElement = triggerElement.querySelector('[ng-mouseover]');
    }
...
function MenuController($mdMenu, $attrs, $element, $scope) {
  ...
  this.init = function(setMenuContainer) {
    ...
    triggerElement = $element[0].querySelector('[ng-mouseover]');
  };
